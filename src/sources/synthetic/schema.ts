...
const arrayOperators: CanonicalOperator[] = [
  "contains",
  "exists",
  "not_exists",
];
...
export const syntheticSourceSchemas: Record<string, SourceSchema> = {
  "synthetic.mail.threads": {
    ...
    fields: {
      ...
      labels: field("labels", "Labels", "array", arrayOperators, {
        repeated: true,
        sortable: false,
      }),
    },
  ...
  "synthetic.tasks": {
    ...
    fields: {
      ...
      due_at: field("due_at", "Due At", "datetime", timeOperators, {
        nullable: true,
      }),
