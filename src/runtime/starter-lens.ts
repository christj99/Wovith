...
export function createDailyWorkLens(): LensDefinition {
  return {
    ...
    description: 'Stage 0 lens showing messages, meetings, docs, and tasks from synthetic sources.',
    createdAt,
    updatedAt: createdAt,
...
export function updateCellAst(cell: CellDefinition, ast: CellAst, updatedAt: string): CellDefinition {
  return {
    ...cell,
    ast,
